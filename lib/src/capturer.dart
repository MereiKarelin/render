...
class RenderCapturer<K extends RenderFormat> {
    ...
    Future<void> _handleCapture(
        ...
        try {
            final ui.Image capture =
                _unhandledCaptures.elementAt(captureNumber);
            // * retrieve bytes
            ...
            await FFmpegKit.executeWithArguments([
                ...
                "-video_size",
                "${capture.width}x${capture.height}", // set capture size
                "-i", rawFile.path, // input the raw frame
                "-vf",
                "scale=${saveSize.width}:${saveSize.height}", // scale to save
    ...
    ui.Image _captureContext(GlobalKey key) {
        try {
            ...
            return renderObject.toImageSync(
    ...
    ui.Image _captureWidget(Widget widget) {
        ...
        try {
            ...
            final BuildOwner buildOwner = BuildOwner(
                focusManager: FocusManager(), onBuildScheduled: () {});
